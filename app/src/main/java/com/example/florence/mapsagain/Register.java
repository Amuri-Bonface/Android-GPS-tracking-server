...
public class Register extends Activity {
    ...
    private static final String URL = "http://boggy-dispatcher.000webhostapp.com/nannie_track/marketers_register.php";
    private static final String URL2 = "http://boggy-dispatcher.000webhostapp.com/nannie_track/clear_nannie.php";
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.navigation_personal:
                    Intent x = new Intent(Register.this,Retrieve_call_sms.class);
                    startActivity(x);
                    finish();
                    return true;
                            }
